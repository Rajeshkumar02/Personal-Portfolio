...
2. Fill in your SMTP configuration:
   ...
   - For other providers: Use your hosting provider's SMTP settings
3. Set your receiving email address in `SMTP_TO`

## Features

- ✅ Responsive navigation with scroll behavior
- ✅ Professional Experience timeline
- ✅ Simplified Projects showcase
- ✅ Optimized About section
- ✅ Skills with experience levels (no percentages)
